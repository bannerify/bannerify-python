...
class Bannerify(BaseSDK):
    ...
    def get_v1_templates_id(
        self, *,
        api_key: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.GetV1TemplatesIDResponseBody]:
        r"""Template details
        ...
        request = models.GetV1TemplatesIDRequest(
            api_key=api_key,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get_/v1/templates/:id", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","403","404","409","429","4XX","500","5XX"],
            retry_config=retry_config
        )
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.GetV1TemplatesIDResponseBody])
        if utils.match_response(http_res, "400", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.GetV1TemplatesIDResponseResponseBodyUnion)
            raise models.GetV1TemplatesIDResponseResponseBody(data=data)
        if utils.match_response(http_res, "401", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ErrUnauthorizedData)
            raise models.ErrUnauthorized(data=data)
        if utils.match_response(http_res, "403", "application/json"):
    ...
    async def get_v1_templates_id_async(
        self, *,
        api_key: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
