...
class Bannerify(BaseSDK):
    ...
    def get_v1_liveness(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.GetV1LivenessResponseBody]:
        r"""
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get_/v1/liveness", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.GetV1LivenessResponseBody])
        if utils.match_response(http_res, "400", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.GetV1LivenessResponseResponseBodyUnion)
            raise models.GetV1LivenessResponseResponseBody(data=data)
    ...
    async def get_v1_liveness_async(
        self, *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
